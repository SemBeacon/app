/* eslint-disable */
if (!window.ol) window.ol = {};
if (!window.ol.transform) window.ol.transform = {};
...
*/
window.ol.transform.Helmert = function (options)
{	if (!options) options={};
...
*/
window.ol.transform.Helmert.prototype.setControlPoints = function(xy, XY)
{	if (xy.length<2) 
	{	this.matrix = [1,0,0,0,1,0];
		this.hasControlPoints = false;
	}
...
* @return {Number}: angle
*/
window.ol.transform.Helmert.prototype.getRotation = function()
{	return this.a_;
}
...
*/
window.ol.transform.Helmert.prototype.getScale = function()
{	return this.sc_
}
...
*/
window.ol.transform.Helmert.prototype.getTranslation = function()
{	return this.tr_;
}
...
*/
window.ol.transform.Helmert.prototype.transform = function(xy)
{	var m = this.matrix;
...
*/
window.ol.transform.Helmert.prototype.revers = function(xy)
{	var a = this.matrix[0];
	var b = this.matrix[1];
	var c = this.matrix[3];
	var d = this.matrix[4];
...
Transformee de Helmert au moindre carre :
	...
	[b  a]
**/
window.ol.transform.Helmert.prototype._similarity = function( xy, XY )
...
Transformee de Helmert-Etendue au moindre carre :
	...
	[b  a][0 h]
**/
window.ol.transform.Helmert.prototype._helmert = function (xy, XY, poids, tol)
{	if ( !xy.length || xy.length != XY.length ) 
	{	console.log ("Helmert : Taille des tableaux de points incompatibles");
		return false; 
	}
